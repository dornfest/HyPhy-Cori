...
q_tr = DataGenerator(list_samplex_dm[:],list_sampley_bm[:],normy=True,max_num=40,fix_direction=False) #note: 3/2/21 changed max_num from 5 to 40, begining test of upper memory usage bounds!
