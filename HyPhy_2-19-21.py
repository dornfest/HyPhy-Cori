...
q_tr = DataGenerator(list_samplex_dm[:],list_sampley_bm[:],normy=True,max_num=5,fix_direction=False) #note: 2/2/21 changed max_num from 5 to 2, memory bugging out at this section.
...
logger = CSVLogger("./log/csv_log_z_2-22-21.csv", separator=',', append=True)
...
hi = Hy.cvae.fit_generator(generator=q_tr,
         shuffle=True,
            verbose=1,
            steps_per_epoch=25, #note: 1/12/21 changed to 3
